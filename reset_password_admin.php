...
$token = $_GET['token'];
$query = mysqli_query($conn, "SELECT * FROM petugas WHERE reset_token = '$token' AND token_expiry > NOW()");
    ...
    <div class="container justify-content-center align-items-center mt-5">
        <div class="row">
            <div class="col-12 border border-dark rounded p-5">
                <div class="container">
                    <form class="container w-10" enctype="multipart/form-data" method="post" action="update_password_admin.php">
