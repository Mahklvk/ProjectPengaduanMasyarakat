...
$countQuery = "SELECT COUNT(*) as total FROM masyarakat";
$whereConditions = [];

// Tambahkan filter untuk counting
if ($filtervalues !== '') {
    $whereConditions[] = "CONCAT(nik, username, email, telp) LIKE '%$filtervalues%'";
}
        ...
        <div class="col-md-4">
            <div class="card card-glass h-100">
                ...
                <div class="card-footer bg-transparent border-0 text-end">
                    <a href="detail_akun_masyarakat.php?p=<?= $data['id_masyarakat'] ?>" class="btn btn-sm btn-outline-light">Detail</a>
                </div>
            </div>
        </div>
        <?php
